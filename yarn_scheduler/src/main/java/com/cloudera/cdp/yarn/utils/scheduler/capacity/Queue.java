...
public class Queue {
    ...
    public static final String[] PROPERTY_NAMES = {"queues", "capacity", "maximum-capacity", "minimum-user-limit-percent", "user-limit-factor",
            "maximum-allocation-mb", "maximum-allocation-vcores", "priority", "state", "acl_submit_applications", "acl_administer_queue",
            "ordering-policy", "accessible-node-labels",
            "disable_preemption", "intra-queue-preemption.disable_preemption", "acl_administer_reservations",
            "acl_list_reservations", "acl_submit_reservations", "reservable", "reservation-agent", "reservation-move-on-expiry",
            "show-reservations-as-queues", "reservation-policy", "reservation-window", "instantaneous-max-capacity", "average-capacity",
            "reservation-planner", "reservation-enforcement-window", "auto-create-child-queue.enabled", "auto-create-child-queue.management-policy",
    "leaf-queue-template.capacity", "acl_administer_jobs", "maximum-applications"};

    private Queue parent = null;
...
//    private Integer maximumAllocationVCores;
    ...
    private Map<String, Queue> children = new TreeMap<String, Queue>();

    public Queue getParent() {
        return parent;
    }

    public void setParent(Queue parent) {
        this.parent = parent;
    }
...
//    }
    ...
    public Map<String, Queue> getChildren() {
        return children;
    }

    public void setChildren(Map<String, Queue> children) {
